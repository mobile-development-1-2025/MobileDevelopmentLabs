...
public final class MessageDao_Impl implements MessageDao {
  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessageEntity = new EntityInsertionAdapter<MessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`userName`,`body`,`postId`) VALUES (?,?,?,?)";
      }
  ...
  @Override
  public Object replaceAll(final List<MessageEntity> messages,
      final Continuation<? super Unit> $completion) {
    return RoomDatabaseKt.withTransaction(__db, (__cont) -> MessageDao.DefaultImpls.replaceAll(MessageDao_Impl.this, messages, __cont), $completion);
  }
  ...
  @Override
  public Flow<List<MessageEntity>> observeMessages() {
      ...
      public List<MessageEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new MessageEntity(_tmpId,_tmpUserName,_tmpBody,_tmpPostId);
            _result.add(_item);
          }
          return _result;
        } finally {
