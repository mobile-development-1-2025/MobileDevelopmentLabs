...
class FeedFragment : Fragment() {
    ...
    private val messageAdapter = MessageAdapter { messageId ->
        feedViewModel.toggleLike(messageId)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabRefresh.setOnClickListener { feedViewModel.refreshMessages() }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                feedViewModel.uiState.collect { state ->
                    ...
                    binding.networkStatusText.text = state.networkStatus
                    binding.networkStatusText.isVisible = state.networkStatus != null
