...
public final class MessageDao_Impl implements MessageDao {
  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessageEntity = new EntityInsertionAdapter<MessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`title`,`body`,`author`,`isLiked`) VALUES (?,?,?,?,?)";
      }
  ...
  @Override
  public Object insertAll(final List<MessageEntity> items,
  ...
  @Override
  public Object replaceAll(final List<MessageEntity> items,
      final Continuation<? super Unit> $completion) {
    return RoomDatabaseKt.withTransaction(__db, (__cont) -> MessageDao.DefaultImpls.replaceAll(MessageDao_Impl.this, items, __cont), $completion);
  }

  @Override
  public Object updateLike(final int id, final boolean liked,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      ...
      public List<MessageEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsLiked = _tmp != 0;
            _item = new MessageEntity(_tmpId,_tmpTitle,_tmpBody,_tmpAuthor,_tmpIsLiked);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAll(final Continuation<? super List<MessageEntity>> $completion) {
